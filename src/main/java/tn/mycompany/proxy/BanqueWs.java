 ...
 * 
 */
@WebServiceClient(name = "BanqueWs", targetNamespace = "http://ws.mycompany.tn/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.mycompany.tn/", "BanqueWs");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.mycompany.tn/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.mycompany.tn/", "BanqueServicePort"), BanqueService.class, features);
    }
